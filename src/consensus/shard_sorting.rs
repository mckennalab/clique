...
use crate::read_strategies::read_set::{ReadSetContainer, ReadSetNestingContainer};
...
pub struct LayerSort {
    umi_configuration: UMIConfiguration,
    containers: ReadSetNestingContainer,
    //initial_containers: Vec<>
}
...
pub struct RoundRobinDiskWriter {
    ...
    assigned_sequences: HashMap<Vec<FastaBase>, usize>,
    assigned_sequences_count: HashMap<Vec<FastaBase>, usize>,
...
impl RoundRobinDiskWriter {
    ...
    pub fn from(run_specs: &mut RunSpecifications, read_pattern: &ReadPattern, read_buffer_size: usize) -> RoundRobinDiskWriter {
        ...
        let mut assigned_sequences: HashMap<Vec<FastaBase>, usize> = HashMap::new();
        let mut assigned_sequences_count: HashMap<Vec<FastaBase>, usize> = HashMap::new();
    ...
    pub fn assign_new_bin(&mut self, sort_string: &Vec<FastaBase>) {
    ...
    pub fn write(&mut self, sort_string: &Vec<FastaBase>, read: &ReadSetContainer) {
